...
get_header(); ?>
	...
	<main id="main" class="site-main" role="main">
		...
		<?php
		if ($_moz_opts['opt_tintuc_home_latest'] === '1') {
		...
		<?php
			$order = 1;
			$home_cats = array();
			if ( empty($_moz_opts['opt_tintuc_home_cats'])) {
				$_home_cats = get_categories(array('parent' => 0));
				foreach ($_home_cats as $item) {
					$home_cats[] = $item->cat_ID;
				}
			} else {
				$home_cats = $_moz_opts['opt_tintuc_home_cats'];
			}
