...
<?php if (!empty($_moz_opts['opt_general_fb_admins'])): ?>
<?php foreach ($_moz_opts['opt_general_fb_admins'] as $fbid): ?>
<meta property="fb:admins" content="<?php echo $fbid; ?>"/>
<?php endforeach ?>
<?php endif ?>
<!-- Moztheme Favicon -->
...
<style type="text/css" media="screen">
	...
	nav .dropdown-menu > li:hover > a {
		color:<?php moz_opt('opt_nav_sub_link_color', 'active'); ?>;
	}
	<?php if($_moz_opts['opt_banhang_show_preview'] == 1) : ?>
	#preview {
		width: <?php echo $_moz_opts['opt_banhang_show_preview_width']; ?>px;
	}
	<?php endif; ?>
...
<!-- Moztheme custom CSS -->
<body <?php body_class(); ?>>
<div id="page" class="hfeed site <?php echo $_moz_opts['opt_layout_type']; ?>">
