...
?>
		...
		<div class="notice notice-warning uct-notice is-dismissible">
			<p>
				<?php printf( esc_html__( 'Bạn cần sử dụng một giao diện con của %s để phục vụ việc cập nhật sau này mà không làm mất đi các tùy chỉnh của bạn.', 'use-child-theme' ), $this->theme->get( 'Name' ) ); ?>
			</p>
		</div>
<?php
		}
		...
		function activate_child_theme() {
			...
			wp_die( esc_html__( 'Kích hoạt giao diện con thành công. Bạn đã có thể bắt đầu sử dụng website của mình!', 'use-child-theme' ) );
		}
