...
function moztheme_posted_on() {
	...
	$author = '<span class=”vcard author post-author”><span class=”fn”>'. get_the_author() .'</span></span>';
...
function _moz_social_sharing( $class = NULL ) {
  ...
  <ul class="no-print _moz_sharing <?php echo $class; ?>">
    <li class="fb"><a href="#" onclick="window.open('https://www.facebook.com/dialog/share?display=popup&app_id=1388042558169121&href=<?php echo $href; ?>&redirect_uri=<?php echo $href; ?>', 'newwindow', 'width=555, height=333, left=200'); return false;"><i class="fa fa-facebook"></i></a></li>
